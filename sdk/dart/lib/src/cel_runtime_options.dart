...
const _defaultWasmIntegrity =
    'sha256-fIMrlm+ovwqauUxcqF6HPCIt3Zph+hsMojHxWDcFJ3U=';
...
final class CelRuntimeOptions {
  const CelRuntimeOptions({
    this.wasmUrl =
        'https://github.com/0xfe10/cel-bridge/releases/download/v0.3.1/cel_bridge.wasm',
    this.wasmExecUrl =
        'https://github.com/0xfe10/cel-bridge/releases/download/v0.3.1/wasm_exec.js',

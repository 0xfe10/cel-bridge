...
Future<void> main(List<String> args) async {
  ...
  try {
    ...
    final goProtocolVersion = int.parse(
      _constant(
        File('${root.path}/internal/protocol/protocol.go'),
    ...
    final runtimeOptions = await File(
      '${root.path}/lib/src/cel_runtime_options.dart',
    ).readAsString();

...
`v0.3` changes how native runtime artifacts are named and described. The C
...
```json
{
  ...
  "file": "cel-bridge-linux-x86_64-static-v0.3.2.tar.gz",
  "sha256": "...",
  "size": 123
}
```
...
| v0.2.0 asset | v0.3 asset |
|---|---|
| `cel-bridge-linux-x86_64-v0.2.0.tar.gz` | `cel-bridge-linux-x86_64-dynamic-v0.3.2.tar.gz` |
| `cel-bridge-linux-aarch64-v0.2.0.tar.gz` | `cel-bridge-linux-aarch64-dynamic-v0.3.2.tar.gz` |
| `cel-bridge-rust-linux-x86_64-v0.2.0.tar.gz` | `cel-bridge-linux-x86_64-static-v0.3.2.tar.gz` |
| `cel-bridge-rust-linux-aarch64-v0.2.0.tar.gz` | `cel-bridge-linux-aarch64-static-v0.3.2.tar.gz` |
| `cel-bridge-macos-x86_64-v0.2.0.tar.gz` | `cel-bridge-macos-x86_64-dynamic-v0.3.2.tar.gz` |
| `cel-bridge-macos-arm64-v0.2.0.tar.gz` | `cel-bridge-macos-arm64-static-v0.3.2.tar.gz` |
| `cel-bridge-rust-macos-x86_64-v0.2.0.tar.gz` | `cel-bridge-macos-x86_64-static-v0.3.2.tar.gz` |
| `cel-bridge-rust-macos-arm64-v0.2.0.tar.gz` | `cel-bridge-macos-arm64-static-v0.3.2.tar.gz` |
| `cel-bridge-rust-windows-x86_64-v0.2.0.zip` and `cel-bridge-windows-x86_64-v0.2.0.zip` | `cel-bridge-windows-x86_64-v0.3.2.zip` |
| Dart and Rust Android assets for each ABI | One `cel-bridge-android-<abi>-v0.3.2.tar.gz` per ABI |
| Dart and Rust iOS assets | `cel-bridge-ios-xcframework-v0.3.2.zip` |
...
```text
<release-root>/v0.3.2/cel-bridge-manifest-v0.3.2.json
<release-root>/v0.3.2/cel-bridge-linux-x86_64-dynamic-v0.3.2.tar.gz
<release-root>/v0.3.2/cel-bridge-linux-x86_64-static-v0.3.2.tar.gz
...
```

For Rust, `CEL_BRIDGE_RELEASE_BASE_URL` is the root before `/v0.3.2`. For the
